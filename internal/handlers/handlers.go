...
<strong>Подтверждение бронирования</strong><br>
Уважаемый(ая): %s,<br>
Ваше Бронирование с %s до %s.
`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))
	...
	htmlMessage = fmt.Sprintf(`
<strong>Новое бронирование</strong><br>
>
У вас новое бронирование для номера %s, с %s до %s.
...
// PostShowLogin handles the login page
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "Неверный email или пароль")
		render.Template(w, r, "login.page.tmpl", &models.TemplateData{
			Form: form,
		})
		return
	...
	m.App.Session.Put(r.Context(), "flash", "Вы успешно вошли в систему")
...
// AdminDashboard displays the admin dashboard page
func (m *Repository) AdminDashboard(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "admin-dashboard.page.tmpl", &models.TemplateData{})
}

// AdminNewReservations displays all new reservations in admin section
...
// AdminAllReservations displays all reservations in admin section
...
// AdminShowReservation displays a single reservation in admin section
func (m *Repository) AdminShowReservation(w http.ResponseWriter, r *http.Request) {
	exploed := strings.Split(r.RequestURI, "/")
	id, err := strconv.Atoi(exploed[4])
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
...
// AdminReservationsCalendar displays all reservations in calendar in admin section
